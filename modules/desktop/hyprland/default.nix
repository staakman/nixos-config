      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          windowrulev2 = [
            ...
            "opacity 0.90 0.90,class:^(codium-url-handler)$"
            "opacity 0.90 0.90,class:^(code)$"
            "opacity 0.90 0.90,class:^(code-url-handler)$"
            "opacity 0.90 0.90,class:^(kitty)$"
            "opacity 0.90 0.90,class:^(terminalFileManager)$"
            "opacity 0.90 0.90,class:^(org.kde.dolphin)$"
            "opacity 0.90 0.90,class:^(org.kde.ark)$"
